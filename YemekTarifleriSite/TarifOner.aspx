...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="btnTarifOner" runat="server" CssClass="fb8" Font-Bold="True" Font-Italic="False" Text="Tarif Öner" Width="252px" OnClick="btnTarifOner_Click" Font-Size="Large" />
            </td>
        </tr>
    </table>
</asp:Content>
